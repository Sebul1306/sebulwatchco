...
<head>
    <meta charset="UTF-8">
    <title>Laporan Pendapatan - Sebul Watch Co.</title>
    <style>
...
<body>
    ...
    <div class="judul-laporan">
        ...
        <span style="font-size: 11px; font-weight: normal; color: #555;">Periode: <?= date('d M Y', strtotime($tanggal_awal)) ?> s/d <?= date('d M Y', strtotime($tanggal_akhir)) ?></span>
    </div>
